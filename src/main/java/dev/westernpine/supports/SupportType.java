package dev.westernpine.supports;
...
import dev.westernpine.supports.types.Ban;
import dev.westernpine.supports.types.Billing;
import dev.westernpine.supports.types.Bug;
import dev.westernpine.supports.types.Question;
import dev.westernpine.supports.types.Request;
import dev.westernpine.supports.types.Suggest;
import dev.westernpine.supports.types.Support;
...
public enum SupportType {
    ...
    TICKET("ticket", "tkt", new dev.westernpine.supports.types.Ticket()),
    ;
